package dev.rikoapp.wear.run.presentation.ambient
...
fun Modifier.ambientMode(
    ...
    val translationX by rememberBurnInProtectionTranslation(
        isAmbientMode = isAmbientMode,
        burnInProtectionRequired = burnInProtectionRequired
    )
    val translationY by rememberBurnInProtectionTranslation(
        isAmbientMode = isAmbientMode,
        burnInProtectionRequired = burnInProtectionRequired
    )
...
@Composable
private fun rememberBurnInProtectionTranslation(
    isAmbientMode: Boolean,
    burnInProtectionRequired: Boolean
): State<Float> {
